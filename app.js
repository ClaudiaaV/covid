...
function getCases() {
    ...
    fetch(api)
        ...
        .then(data => {
            ...
            document.getElementById("demo").innerHTML = "Cazuri înregistrate: " + `${vectorCazuri[ultimaZi].Cazuri ?? 'Nu exista cazuri raportate astazi'}`;
            ...
            document.getElementById("demo6").innerHTML = "Număr total cazuri: " + `${vectorCazuri[ultimaZi].Total ?? 'Nu exista cazuri raportate astazi'}`;
            ...
            document.getElementById("demo17").innerHTML = "Persoane la terapie intensivă: " + `${vectorCazuri[ultimaZi]['Terapie intensiva'] ?? 'Nu exista cazuri raportate astazi'}`;
