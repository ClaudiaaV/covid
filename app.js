...
function getCases() {
    ...
    fetch(api)
        ...
        document.getElementById("demo7").innerHTML ="Data: " + data.data.data[454].Data;
        document.getElementById("demo").innerHTML ="Cazuri înregistrate: " + data.data.data[454].Cazuri;
        document.getElementById("demo8").innerHTML ="Cazuri active:  " + data.data.data[454]["Cazuri active"];
        
        document.getElementById("demo6").innerHTML ="Număr total cazuri: " + data.data.data[454].Total;
        document.getElementById("demo4").innerHTML ="Pacienți la terapie intensivă: " + data.data.data[454]["Terapie intensiva"];
        document.getElementById("demo9").innerHTML ="Număr persoane decedate: " + data.data.data[454].Morti;
        document.getElementById("demo10").innerHTML ="Număr teste efectuate: " + data.data.data[454]["Nr de teste pe zi"];
        document.getElementById("demo11").innerHTML ="Procent teste pozitive: " + data.data.data[454]["Procentaj de teste pozitive"] + "%";
        document.getElementById("demo12").innerHTML ="Persoane vindecate: " + data.data.data[454]["Vindecati pe zi"];
        document.getElementById("demo13").innerHTML ="Total persoane vindecate: " + data.data.data[454].Vindecati;
